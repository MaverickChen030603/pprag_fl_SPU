...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--strategy",
        default="hypernet_v5",
        choices=["full", "random", "static_top", "delta_norm", "hypernet_v2", "hypernet_v3", "hypernet_v5"],
    )
    ...
    parser.add_argument("--suite-tag", default="v5_adhoc")
    ...
    parser.add_argument("--budget-mode", choices=["fixed", "adaptive", "adaptive_v5"], default="adaptive_v5")
