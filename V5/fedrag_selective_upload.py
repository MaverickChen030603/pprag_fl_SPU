...
class Server(BasicServer):
    def initialize(self, *args, **kwargs):
        ...
        self.selection_strategy = self.option.get("selection_strategy", "hypernet_v5")
        ...
        self.output_dir = ensure_dir(self.option.get("output_dir", "V5/outputs/manual_run"))
        self.score_mode = str(self.option.get("score_mode", "downstream_value"))
        self.budget_mode = str(self.option.get("budget_mode", "adaptive_v5"))
        ...
        self.suite_tag = str(self.option.get("suite_tag", "v5"))
        ...
        if self.selection_strategy in {"hypernet_v2", "hypernet_v3", "hypernet_v5"}:
            hypernet_cls = DownstreamAwareHyperNetwork if self.selection_strategy == "hypernet_v5" else ValueAwareHyperNetwork
    ...
    def _select_upload_blocks(self, client_id: int):
        ...
        if self.hypernet is not None:
            ...
            if self.budget_mode in {"adaptive", "adaptive_v5"}:
