...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run downstream RAG evaluation for every upstream V5 run.")
    parser.add_argument("--upstream-root", default=str(OUTPUT_ROOT / "pprag_fl_v5"))
    parser.add_argument("--output-root", default=str(OUTPUT_ROOT / "rag_eval_all_v5"))
