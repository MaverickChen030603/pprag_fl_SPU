...
REPORT_ROOT = REPO_ROOT / "实验分析报告" / "V7-agent-2"
...
class UpstreamConfig:
    experiment_name: str = "pprag_fl_v7agent2"
    ...
    def output_dir(self) -> Path:
        ...
        tag = (
            ...
            f"{score_tag}_{budget_tag}_{hist_tag}_{client_tag}_{block_tag}_{hard_tag}_{util_tag}_{early_tag}_{cov_tag}_{mem_tag}_{dyn_tag}_{ecw_tag}"
        )
