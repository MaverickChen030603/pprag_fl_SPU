...
OUTPUT_ROOT = REPO_ROOT / "V4" / "outputs"
REPORT_ROOT = REPO_ROOT / "实验分析报告" / "V4"
...
class UpstreamConfig:
    experiment_name: str = "pprag_fl_v4"
    task_name: str = "num5_dir_a03_imb00_ts0_v4"
    suite_tag: str = "v4_main"
    num_clients: int = 5
    num_rounds: int = 25
    num_epochs: int = 1
    batch_size: int = 8
    ...
    gpu: int = 0
    seed: int = 0
    selection_strategy: str = "hypernet_v4"
    topk_blocks: int = 3
    warmup_rounds: int = 1
