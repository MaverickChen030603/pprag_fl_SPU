...
class UploadSelector:
    ...
    def select(
        ...
        if self.strategy in {"agent_tail_v7hp2", "agent_memory_v7hp2", "agent_oracle_v7hp2"}:
            ...
            if client_hardness >= hard_client_threshold and self.strategy != "agent_memory_v7hp2":
