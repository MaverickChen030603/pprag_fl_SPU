...
def main() -> int:
    official_root = Path('V7-HP3/outputs/hotpot_official_fullwiki_dev300')
    reader_root = Path('V7-HP3/outputs/hotpot_reader_fullwiki_t5small_dev300')
    ...
    path = report_dir / f'v7_hp3_reader_alignment_{ts}.md'
    latest = report_dir / 'v7_hp3_reader_alignment_latest.md'
    lines = [
        '# V7-HP3 Reader-Aware Agent 实验报告',
        '',
