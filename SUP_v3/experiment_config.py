...
OUTPUT_ROOT = REPO_ROOT / "SUP_v3" / "outputs"
REPORT_ROOT = REPO_ROOT / "实验分析报告" / "V2"
...
class UpstreamConfig:
    experiment_name: str = "pprag_fl_sup_v3"
    task_name: str = "num5_id_ts0_sup_v3"
    suite_tag: str = "adhoc"
    num_clients: int = 5
    num_rounds: int = 25
    num_epochs: int = 1
    ...
    partitioner_name: str = "IDPartitioner"
