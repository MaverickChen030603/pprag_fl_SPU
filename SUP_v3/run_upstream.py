...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run SUP_v3 upstream FL experiment.")
    ...
    parser.add_argument("--suite-tag", default="adhoc")
    parser.add_argument("--task-name", default="")
    parser.add_argument("--partitioner", default="IDPartitioner", choices=["IDPartitioner", "DirichletPartitioner"])
    parser.add_argument("--dir-alpha", type=float, default=0.5)
