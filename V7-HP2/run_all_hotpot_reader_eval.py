#!/usr/bin/env python3
"""Batch reader/generator Hotpot answer evaluation for V7-HP2 runs."""
...
def main() -> int:
    ...
    p.add_argument("--upstream-root", type=Path, default=Path("V7-HP2/outputs/pprag_fl_v7_hp2"))
    p.add_argument("--output-root", type=Path, default=Path("V7-HP2/outputs/hotpot_reader_eval"))
    ...
    rows = []
    script = Path("V7-HP2/run_hotpot_reader_eval.py")
