...
OUTPUT_ROOT = REPO_ROOT / "V7-HP2" / "outputs"
REPORT_ROOT = REPO_ROOT / "实验分析报告" / "V7-HP2"
...
class UpstreamConfig:
    experiment_name: str = "pprag_fl_v7_hp2"
    ...
    def suite_root(self) -> Path:
        return REPO_ROOT / "V7-HP2" / "outputs" / self.experiment_name / self.suite_tag
