...
AGENT_STRATEGY_OVERLAYS = {
    ...
    "agent_tail_v7hp2": {
        "selection_strategy": "agent_tail_v7hp2",
    ...
    "agent_memory_v7hp2": {
        "selection_strategy": "agent_memory_v7hp2",
    ...
    "agent_oracle_v7hp2": {
        "selection_strategy": "agent_oracle_v7hp2",
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run V7-HP2 HotpotQA upstream FL experiment.")
    parser.add_argument(
        "--strategy",
        default="hypernet_v6",
        choices=[
    ...
    parser.add_argument("--experiment-name", default="pprag_fl_v7_hp2")
    parser.add_argument("--suite-tag", default="hp2_adhoc")
