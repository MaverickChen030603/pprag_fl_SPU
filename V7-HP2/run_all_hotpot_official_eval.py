#!/usr/bin/env python3
"""Batch Hotpot-style QA/supporting-fact evaluation for V7-HP2 runs."""
...
def main() -> int:
    ...
    parser.add_argument("--upstream-root", type=Path, default=Path("V7-HP2/outputs/pprag_fl_v7_hp2"))
    ...
    parser.add_argument("--suite", action="append", help="Suite tag(s), comma-separated or repeated. Default: hp2_budget_aligned")
    ...
    suites = split_csv(args.suite) or {"hp2_budget_aligned"}
    ...
    eval_script = Path("V7-HP2/run_hotpot_official_eval.py")
