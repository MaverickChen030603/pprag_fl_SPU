...
OUTPUT_ROOT = REPO_ROOT / "V6-H1" / "outputs"
REPORT_ROOT = REPO_ROOT / "实验分析报告" / "V6-H1"
...
class UpstreamConfig:
    experiment_name: str = "pprag_fl_v6_h1"
    task_name: str = "num5_dir_a03_imb00_ts0_v6h1"
    suite_tag: str = "v6h1_main"
    num_clients: int = 5
    num_rounds: int = 25
    num_epochs: int = 1
    batch_size: int = 8
    ...
    def suite_root(self) -> Path:
        return REPO_ROOT / "V6-H1" / "outputs" / self.experiment_name / self.suite_tag
