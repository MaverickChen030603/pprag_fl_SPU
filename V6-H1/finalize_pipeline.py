...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Finalize the V6-H1 upstream + downstream experiment pipeline.")
    parser.add_argument("--suite-name", default="all")
    parser.add_argument("--wait-pid", type=int, default=0)
    parser.add_argument("--poll-seconds", type=int, default=120)
    parser.add_argument("--upstream-root", default=str(OUTPUT_ROOT / "pprag_fl_v6_h1" / "v6h1_adhoc"))
    parser.add_argument("--downstream-root", default=str(OUTPUT_ROOT / "rag_eval_all_v6_h1" / "v6h1_adhoc"))
    parser.add_argument("--script", default="main_100_test.py")
    parser.add_argument("--python", default=sys.executable)
    parser.add_argument("--query-subset", default="")
...
def main() -> None:
    ...
    if args.query_subset:
        rag_command.extend(["--query-subset", args.query_subset])
