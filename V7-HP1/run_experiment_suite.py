...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run V7-HP1 HotpotQA multihop agent-gap experiments.")
    parser.add_argument(
        "--suite",
...
def main() -> int:
    ...
    print(f"V7-HP1 suite analysis report written to {report_path}")
    return 0
