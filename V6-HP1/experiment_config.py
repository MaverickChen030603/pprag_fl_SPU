...
OUTPUT_ROOT = REPO_ROOT / "V6-HP1" / "outputs"
REPORT_ROOT = REPO_ROOT / "实验分析报告" / "V6-HP1"
DEFAULT_HOTPOT_RAWDATA = FEDE_DIR / "select_data_hotpot_train_5000.json"
...
class UpstreamConfig:
    experiment_name: str = "pprag_fl_v6_hp1"
    task_name: str = "num5_dir_a03_imb00_ts0_v6hp1"
    suite_tag: str = "v6hp1_main"
    rawdata_path: str = str(DEFAULT_HOTPOT_RAWDATA)
    ...
    def suite_root(self) -> Path:
        return REPO_ROOT / "V6-HP1" / "outputs" / self.experiment_name / self.suite_tag
    ...
    def output_dir(self) -> Path:
        ...
        tag = (
            ...
            f"{score_tag}_{budget_tag}_{hist_tag}_{client_tag}_{block_tag}_{hard_tag}_{util_tag}"
        )
