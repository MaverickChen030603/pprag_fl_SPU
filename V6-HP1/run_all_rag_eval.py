...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run downstream RAG evaluation for every upstream V6-HP1 run.")
    parser.add_argument("--upstream-root", default=str(OUTPUT_ROOT / "pprag_fl_v6_hp1"))
    parser.add_argument("--output-root", default=str(OUTPUT_ROOT / "rag_eval_all_v6_hp1"))
