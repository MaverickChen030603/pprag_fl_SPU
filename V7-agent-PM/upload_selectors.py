...
PM_COMPAT_STRATEGIES = PM_AGENT_STRATEGIES | DYNAMIC_PLANNING_STRATEGIES | FIXED_SLOT_STRATEGIES | {
...
class UploadSelector:
    ...
    def select(
        ...
        if self.strategy in {"agent_rule_v7", "agent_bandit_v7"} or self.strategy in PM_COMPAT_STRATEGIES:
            scorer_strategy = "agent_bandit_v7" if self.strategy == "agent_pm_bandit_slot" else "agent_rule_v7"
