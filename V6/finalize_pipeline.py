...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--upstream-root", default=str(OUTPUT_ROOT / "pprag_fl_v6" / "v6_adhoc"))
    parser.add_argument("--downstream-root", default=str(OUTPUT_ROOT / "rag_eval_all_v6" / "v6_adhoc"))
