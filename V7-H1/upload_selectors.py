...
class UploadSelector:
    ...
    def select(
        ...
        if self.strategy in {"agent_tail_v7h1", "agent_memory_v7h1", "agent_oracle_v7h1"}:
            ...
            if client_hardness >= hard_client_threshold and self.strategy != "agent_memory_v7h1":
