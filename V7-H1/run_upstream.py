...
AGENT_STRATEGY_OVERLAYS = {
    ...
    "agent_tail_v7h1": {
        "selection_strategy": "agent_tail_v7h1",
    ...
    "agent_memory_v7h1": {
        "selection_strategy": "agent_memory_v7h1",
    ...
    "agent_oracle_v7h1": {
        "selection_strategy": "agent_oracle_v7h1",
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run V5 upstream FL experiment.")
    parser.add_argument(
        "--strategy",
        default="hypernet_v6",
        choices=[
    ...
    parser.add_argument("--suite-tag", default="h1_adhoc")
