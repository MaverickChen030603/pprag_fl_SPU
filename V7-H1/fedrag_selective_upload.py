...
class Server(BasicServer):
    def initialize(self, *args, **kwargs):
        ...
        if self.selection_strategy in {"hypernet_v2", "hypernet_v3", "hypernet_v5", "hypernet_v6", "agent_tail_v7h1", "agent_memory_v7h1", "agent_oracle_v7h1"}:
            hypernet_cls = DownstreamAwareHyperNetwork if self.selection_strategy in {"hypernet_v5", "hypernet_v6", "agent_tail_v7h1", "agent_memory_v7h1", "agent_oracle_v7h1"} else ValueAwareHyperNetwork
