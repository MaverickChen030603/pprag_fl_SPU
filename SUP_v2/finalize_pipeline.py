...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Finalize the SUP_v2 upstream + downstream experiment pipeline.")
    ...
    parser.add_argument("--downstream-root", default=str(OUTPUT_ROOT / "rag_eval_all"))
