...
class Server(BasicServer):
    def initialize(self, *args, **kwargs):
        ...
        self.selection_strategy = self.option.get("selection_strategy", "hypernet_v3")
        ...
        self.output_dir = ensure_dir(self.option.get("output_dir", "V3/outputs/manual_run"))
        ...
        self.suite_tag = str(self.option.get("suite_tag", "v3"))
        ...
        if self.selection_strategy in {"hypernet_v2", "hypernet_v3"}:
            self.hypernet = ValueAwareHyperNetwork(
    ...
    def _log_round(self, client_updates: Mapping[str, List]) -> None:
        ...
        self.gv.logger.info(
            "V3 round {} strategy={} avg_payload={:.4f} avg_budget_topk={:.2f}".format(
                record["round"],
                record["strategy"],
