...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run downstream RAG evaluation for every upstream V3 run.")
    parser.add_argument("--upstream-root", default=str(OUTPUT_ROOT / "pprag_fl_v3"))
    parser.add_argument("--output-root", default=str(OUTPUT_ROOT / "rag_eval_all_v3"))
