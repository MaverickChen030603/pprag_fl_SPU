...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run V3 upstream FL experiment.")
    parser.add_argument(
        "--strategy",
        default="hypernet_v3",
        choices=["full", "random", "static_top", "delta_norm", "hypernet_v2", "hypernet_v3"],
    )
    ...
    parser.add_argument("--suite-tag", default="v3_adhoc")
    ...
    parser.add_argument("--score-mode", choices=["importance", "value"], default="value")
    parser.add_argument("--budget-mode", choices=["fixed", "adaptive"], default="adaptive")
...
def main() -> None:
    ...
    print(f"V3 analysis report written to {report_path}")
