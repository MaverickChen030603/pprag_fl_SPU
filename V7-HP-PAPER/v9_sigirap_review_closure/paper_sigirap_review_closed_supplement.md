...
## P. Explicit No-Leak Audit Checklist
...
| Split | No training-positive action | Training-positive action missed | Training-positive action selected | Harmful selected (Joint) | Mean regret | P90 | P95 | Zero regret |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
...
## R. Protocol-Matched Shared-Checkpoint CrossEncoder-Top5 Details
