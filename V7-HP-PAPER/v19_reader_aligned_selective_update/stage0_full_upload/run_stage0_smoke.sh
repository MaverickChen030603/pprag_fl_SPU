...
PROJECT="$(cd "$ROOT/../.." && pwd)"
PAPER_ROOT="$PROJECT/V7-HP-PAPER"
...
POOL="$PAPER_ROOT/v17_fedaction_rag/oracle/phase_a_checkpoint100/pools/${DATASET}_topic_silo.jsonl"
ASSIGNMENT="$PAPER_ROOT/v17_fedaction_rag/partitions/assignments/${DATASET}/topic_silo_m20.jsonl"
DATA="$PAPER_ROOT/v17_fedaction_rag/data/${DATASET}"
