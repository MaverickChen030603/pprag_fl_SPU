#!/usr/bin/env python3
"""Batch reader/generator Hotpot answer evaluation for V7-HP3 runs."""
...
def main() -> int:
    ...
    p.add_argument("--upstream-root", type=Path, default=Path("V7-HP3/outputs/pprag_fl_v7_hp3"))
    p.add_argument("--output-root", type=Path, default=Path("V7-HP3/outputs/hotpot_reader_eval"))
    ...
    rows = []
    script = Path("V7-HP3/run_hotpot_reader_eval.py")
    for idx, run_dir in enumerate(runs, 1):
        ...
        if metrics_path.exists() and not args.force:
            ...
            cmd = [
                ...
                "--fallback-reader-model", args.fallback_reader_model,
