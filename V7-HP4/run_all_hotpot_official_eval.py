#!/usr/bin/env python3
"""Batch Hotpot-style QA/supporting-fact evaluation for V7-HP3 runs."""
...
def main() -> int:
    ...
    parser.add_argument("--upstream-root", type=Path, default=Path("V7-HP3/outputs/pprag_fl_v7_hp3"))
    ...
    eval_script = Path("V7-HP3/run_hotpot_official_eval.py")
