...
def parse_args():
    p = argparse.ArgumentParser(description="Compute V7-HP3 HotpotQA multihop strict diagnostic metrics from selection traces.")
...
def main() -> None:
    ...
    print(f"Processed {len(rows)} HP3 strict diagnostic runs into {output_root}")
