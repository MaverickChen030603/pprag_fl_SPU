...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run isolated V7-agent HotpotQA agent-rule experiments.")
    parser.add_argument(
        "--suite",
    ...
    parser.add_argument("--experiment-name", default="pprag_fl_v7_agent")
...
def main() -> int:
    ...
    print(f"V7-agent suite analysis report written to {report_path}")
    return 0
